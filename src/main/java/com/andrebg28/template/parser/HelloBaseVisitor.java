...
public class HelloBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements HelloVisitor<T> {
	 ...
	 */
	@Override public T visitLinhas(HelloParser.LinhasContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitLinha(HelloParser.LinhaContext ctx) { return visitChildren(ctx); }
}